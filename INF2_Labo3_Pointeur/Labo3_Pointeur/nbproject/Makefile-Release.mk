...
${OBJECTDIR}/_ext/8c3c5305/Carte.o: ../Labo_3/Carte.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c3c5305/Carte.o ../Labo_3/Carte.cpp

${OBJECTDIR}/_ext/8c3c5305/Joueur.o: ../Labo_3/Joueur.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c3c5305
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c3c5305/Joueur.o ../Labo_3/Joueur.cpp

${OBJECTDIR}/_ext/8c3c5305/Partie.o: ../Labo_3/Partie.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c3c5305
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c3c5305/Partie.o ../Labo_3/Partie.cpp

${OBJECTDIR}/_ext/8c3c5305/main.o: ../Labo_3/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8c3c5305
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8c3c5305/main.o ../Labo_3/main.cpp
